(function webpackUniversalModuleDefinition(root, factory) {
        ...
        /***/ function (module, exports, __webpack_require__) {
...

          {
            const defineMath = (name, assignment) => {
              var configurable =
                typeof assignment === "function" ? true : false;
                    ...
                    value: function updateAudioLevels(fps, frame) {
                      if (this.audio.freqArray.length > 0) {
                        ...
                        for (var _i = 0; _i < 3; _i++) {
                          ...
                          this.avg[_i] =
                            this.avg[_i] * rate + this.imm[_i] * (1 - rate);
                          ...
                          this.longAvg[_i] =
                            this.longAvg[_i] * rate + this.imm[_i] * (1 - rate);
  ...
  \*************************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var _fft__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(/*! ./fft */ "./src/audio/fft.js");
          function _classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) {
              throw new TypeError("Cannot call a class as a function");
            }
          ...
          var AudioProcessor =
            ...
            (function () {
              function AudioProcessor(context) {
                ...
                this.fft = new _fft__WEBPACK_IMPORTED_MODULE_0__["default"](
                  this.fftSize,
                  512,
                  true
                );
                  ...
                  value: function processAudio() {
                    for (var i = 0, j = 0, lastIdx = 0; i < this.fftSize; i++) {
                      ...
                      this.timeByteArraySignedL[i] =
                        this.timeByteArrayL[i] - 128;
                      this.timeByteArraySignedR[i] =
                        this.timeByteArrayR[i] - 128;
                      ...
                      this.tempTimeArrayR[i] =
                        0.5 *
                        (this.timeByteArraySignedR[i] +
                          this.timeByteArraySignedR[lastIdx]); // Undersampled
                  ...
                  value: function timeToFrequencyDomain(waveDataIn) {
                    ...
                    if (this.equalize) {
                      for (var _i3 = 0; _i3 < this.samplesOut; _i3++) {
                        spectralDataOut[_i3] =
                          this.equalizeArr[_i3] *
                          Math.sqrt(
                            real[_i3] * real[_i3] + imag[_i3] * imag[_i3]
                          );
                      }
                    } else {
                      for (var _i4 = 0; _i4 < this.samplesOut; _i4++) {
                        spectralDataOut[_i4] = Math.sqrt(
                          real[_i4] * real[_i4] + imag[_i4] * imag[_i4]
                        );
                      }
                    }
          ...
          var PresetEquationRunner =
            ...
            (function () {
              function PresetEquationRunner(preset, globalVars, opts) {
                ...
                this.qs = _utils__WEBPACK_IMPORTED_MODULE_0__["default"]
                  .range(1, 33)
                  .map(function (x) {
                    return "q".concat(x);
                  });
                this.ts = _utils__WEBPACK_IMPORTED_MODULE_0__["default"]
                  .range(1, 9)
                  .map(function (x) {
                    return "t".concat(x);
                  });
                this.regs = _utils__WEBPACK_IMPORTED_MODULE_0__["default"]
                  .range(100)
                  .map(function (x) {
                    if (x < 10) {
              ...
              _createClass(PresetEquationRunner, [
                {
                  ...
                  value: function initializeEquations(globalVars) {
                    ...
                    var mdVSAfterInit = this.preset.init_eqs(
                      _utils__WEBPACK_IMPORTED_MODULE_0__["default"].cloneVars(
                        this.mdVS
                      )
                    ); // qs need to be initialized to there init values every frame

                    this.mdVSQInit = _utils__WEBPACK_IMPORTED_MODULE_0__[
                      "default"
                    ].pick(mdVSAfterInit, this.qs);
                    this.mdVSRegs = _utils__WEBPACK_IMPORTED_MODULE_0__[
                      "default"
                    ].pick(mdVSAfterInit, this.regs);
                    var initUserVars = _utils__WEBPACK_IMPORTED_MODULE_0__[
                      "default"
                    ].pick(
                      mdVSAfterInit,
                      Object.keys(
                        _utils__WEBPACK_IMPORTED_MODULE_0__["default"].omit(
                          mdVSAfterInit,
                          nonUserKeys
                        )
                      )
                    ...
                    this.mdVSFrameMap = _utils__WEBPACK_IMPORTED_MODULE_0__[
                      "default"
                    ].pick(this.mdVSFrame, this.mdVSUserKeys); // qs for shapes

                    this.mdVSQAfterFrame = _utils__WEBPACK_IMPORTED_MODULE_0__[
                      "default"
                    ].pick(this.mdVSFrame, this.qs);
                    this.mdVSRegs = _utils__WEBPACK_IMPORTED_MODULE_0__[
                      "default"
                    ].pick(this.mdVSFrame, this.regs);
                    this.mdVSWaves = [];
                    this.mdVSTWaveInits = [];
                      ...
                      for (var i = 0; i < this.preset.waves.length; i++) {
                        ...
                        if (baseVals.enabled !== 0) {
                          ...
                          if (wave.init_eqs) {
                            ...
                            this.mdVSRegs = _utils__WEBPACK_IMPORTED_MODULE_0__[
                              "default"
                            ].pick(mdVSWave, this.regs); // base vals need to be reset
                          ...
                          this.mdVSTWaveInits.push(
                            _utils__WEBPACK_IMPORTED_MODULE_0__["default"].pick(
                              mdVSWave,
                              this.ts
                            )
                          );
                      ...
                      for (var _i = 0; _i < this.preset.shapes.length; _i++) {
                        ...
                        if (_baseVals.enabled !== 0) {
                          ...
                          if (shape.init_eqs) {
                            ...
                            this.mdVSRegs = _utils__WEBPACK_IMPORTED_MODULE_0__[
                              "default"
                            ].pick(mdVSShape, this.regs); // base vals need to be reset
                          ...
                          this.mdVSUserKeysShapes.push(
                            Object.keys(
                              _utils__WEBPACK_IMPORTED_MODULE_0__[
                                "default"
                              ].omit(mdVSShape, nonUserShapeKeys)
                            )
                          );
                ...
                },
                {
                  ...
                  value: function runFrameEquations(globalVars) {
                    ...
                    this.mdVSFrameMap = _utils__WEBPACK_IMPORTED_MODULE_0__[
                      "default"
                    ].pick(this.mdVSFrame, this.mdVSUserKeys);
                    this.mdVSQAfterFrame = _utils__WEBPACK_IMPORTED_MODULE_0__[
                      "default"
                    ].pick(this.mdVSFrame, this.qs);
                  },
  ...
  \**********************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var ecma_proposal_math_extensions__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(
              /*! ecma-proposal-math-extensions */ "./node_modules/ecma-proposal-math-extensions/reference-implementation/index.js"
            );
          /* harmony import */ var ecma_proposal_math_extensions__WEBPACK_IMPORTED_MODULE_0___default =
            /*#__PURE__*/ __webpack_require__.n(
              ecma_proposal_math_extensions__WEBPACK_IMPORTED_MODULE_0__
            );
          /* harmony import */ var _presetBase__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(/*! ./presetBase */ "./src/presetBase.js");
          /* harmony import */ var _presetBase__WEBPACK_IMPORTED_MODULE_1___default =
            /*#__PURE__*/ __webpack_require__.n(
              _presetBase__WEBPACK_IMPORTED_MODULE_1__
            );
          /* harmony import */ var _visualizer__WEBPACK_IMPORTED_MODULE_2__ =
              ...
              _createClass(Butterchurn, null, [
                {
                  ...
                  value: function createVisualizer(context, canvas, opts) {
                    return new _visualizer__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ](context, canvas, opts);
                  },
                },
                        ...
                        for (var z = 0; z < noiseSize; z += zoom) {
                          for (var y = 0; y < noiseSize; y += zoom) {
                            for (var x = 0; x < noiseSize; x++) {
                              if (x % zoom !== 0) {
                                var baseX =
                                  Math.floor(x / zoom) * zoom + noiseSize;
                                var baseY =
                                  z * wordsPerSlice + y * wordsPerLine;
                                var y0 = [];
                                var y1 = [];
                                var y2 = [];
                                var y3 = [];
                    ...
                    value: function createBlendPattern() {
                      ...
                      if (mixType === 0) {
                        ...
                        for (var _y4 = 0; _y4 <= this.mesh_height; _y4++) {
                          var dy =
                            (_y4 / this.mesh_height - 0.5) * this.aspecty;

                          for (var _x4 = 0; _x4 <= this.mesh_width; _x4++) {
                            var dx =
                              (_x4 / this.mesh_width - 0.5) * this.aspectx;
                            ...
                            this.vertInfoC[_nVert3] =
                              -_invBand2 + _invBand2 * _t2;
                            _nVert3 += 1;
                          }
                        }
                      }
  ...
  \******************************************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var _shaders_shaderUtils__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(
              /*! ../shaders/shaderUtils */ "./src/rendering/shaders/shaderUtils.js"
            );
          function _classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) {
              throw new TypeError("Cannot call a class as a function");
          ...
          var MotionVectors =
            ...
            (function () {
              function MotionVectors(gl, opts) {
                ...
                this.floatPrecision =
                  _shaders_shaderUtils__WEBPACK_IMPORTED_MODULE_0__[
                    "default"
                  ].getFragmentFloatPrecision(this.gl);
                this.createShader();
              }
              ...
              _createClass(MotionVectors, [
                ...
                },
                {
                  ...
                  value: function createShader() {
                    ...
                    var vertShader = this.gl.createShader(
                ...
                },
                {
                  ...
                  value: function getMotionDir(warpUVs, fx, fy) {
                    ...
                    var fy2;
                    fx2 =
                      warpUVs[(y0 * gridX1 + x0) * 2 + 0] * (1 - dx) * (1 - dy);
                    fy2 =
                      warpUVs[(y0 * gridX1 + x0) * 2 + 1] * (1 - dx) * (1 - dy);
                        ...
                        if (fy > 0.0001 && fy < 0.9999) {
                          for (var i = 0; i < nX; i++) {
                            ...
                            if (fx > 0.0001 && fx < 0.9999) {
                              ...
                              this.positions[(this.numVecVerts + 1) * 3 + 0] =
                                vx2;
                              this.positions[(this.numVecVerts + 1) * 3 + 1] =
                                vy2;
                              this.positions[
  ...
  \***********************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var _audio_audioLevels__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(
              /*! ../audio/audioLevels */ "./src/audio/audioLevels.js"
            );
          /* harmony import */ var _blankPreset__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(/*! ../blankPreset */ "./src/blankPreset.js");
          /* harmony import */ var _blankPreset__WEBPACK_IMPORTED_MODULE_1___default =
            /*#__PURE__*/ __webpack_require__.n(
              _blankPreset__WEBPACK_IMPORTED_MODULE_1__
            );
          /* harmony import */ var _equations_presetEquationRunner__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(
              /*! ../equations/presetEquationRunner */ "./src/equations/presetEquationRunner.js"
            );
          /* harmony import */ var _waves_basicWaveform__WEBPACK_IMPORTED_MODULE_3__ =
            __webpack_require__(
              /*! ./waves/basicWaveform */ "./src/rendering/waves/basicWaveform.js"
            );
          /* harmony import */ var _waves_customWaveform__WEBPACK_IMPORTED_MODULE_4__ =
            __webpack_require__(
              /*! ./waves/customWaveform */ "./src/rendering/waves/customWaveform.js"
            );
          /* harmony import */ var _shapes_customShape__WEBPACK_IMPORTED_MODULE_5__ =
            __webpack_require__(
              /*! ./shapes/customShape */ "./src/rendering/shapes/customShape.js"
            );
          /* harmony import */ var _sprites_border__WEBPACK_IMPORTED_MODULE_6__ =
            __webpack_require__(
              /*! ./sprites/border */ "./src/rendering/sprites/border.js"
            );
          /* harmony import */ var _sprites_darkenCenter__WEBPACK_IMPORTED_MODULE_7__ =
            __webpack_require__(
              /*! ./sprites/darkenCenter */ "./src/rendering/sprites/darkenCenter.js"
            );
          /* harmony import */ var _motionVectors_motionVectors__WEBPACK_IMPORTED_MODULE_8__ =
            __webpack_require__(
              /*! ./motionVectors/motionVectors */ "./src/rendering/motionVectors/motionVectors.js"
            );
          /* harmony import */ var _shaders_warp__WEBPACK_IMPORTED_MODULE_9__ =
            __webpack_require__(
              /*! ./shaders/warp */ "./src/rendering/shaders/warp.js"
            );
          /* harmony import */ var _shaders_comp__WEBPACK_IMPORTED_MODULE_10__ =
            __webpack_require__(
              /*! ./shaders/comp */ "./src/rendering/shaders/comp.js"
            );
          /* harmony import */ var _shaders_output__WEBPACK_IMPORTED_MODULE_11__ =
            __webpack_require__(
              /*! ./shaders/output */ "./src/rendering/shaders/output.js"
            );
          /* harmony import */ var _shaders_resample__WEBPACK_IMPORTED_MODULE_12__ =
            __webpack_require__(
              /*! ./shaders/resample */ "./src/rendering/shaders/resample.js"
            );
          /* harmony import */ var _shaders_blur_blur__WEBPACK_IMPORTED_MODULE_13__ =
            __webpack_require__(
              /*! ./shaders/blur/blur */ "./src/rendering/shaders/blur/blur.js"
            );
          /* harmony import */ var _noise_noise__WEBPACK_IMPORTED_MODULE_14__ =
            __webpack_require__(/*! ../noise/noise */ "./src/noise/noise.js");
          /* harmony import */ var _image_imageTextures__WEBPACK_IMPORTED_MODULE_15__ =
            __webpack_require__(
              /*! ../image/imageTextures */ "./src/image/imageTextures.js"
            );
          /* harmony import */ var _text_titleText__WEBPACK_IMPORTED_MODULE_16__ =
            __webpack_require__(
              /*! ./text/titleText */ "./src/rendering/text/titleText.js"
            );
          /* harmony import */ var _blendPattern__WEBPACK_IMPORTED_MODULE_17__ =
            __webpack_require__(
              /*! ./blendPattern */ "./src/rendering/blendPattern.js"
            );
          /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_18__ =
            __webpack_require__(/*! ../utils */ "./src/utils.js");
          function _classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) {
              throw new TypeError("Cannot call a class as a function");
          ...
          var Renderer =
            ...
            (function () {
              function Renderer(gl, audio, opts) {
                ...
                this.pixelRatio =
                  opts.pixelRatio || window.devicePixelRatio || 1;
                this.textureRatio = opts.textureRatio || 1;
                this.outputFXAA = opts.outputFXAA || false;
                this.texsizeX =
                  this.width * this.pixelRatio * this.textureRatio;
                this.texsizeY =
                  this.height * this.pixelRatio * this.textureRatio;
                this.aspectx =
                ...
                this.invAspectx = 1.0 / this.aspectx;
                this.invAspecty = 1.0 / this.aspecty;
                this.qs = _utils__WEBPACK_IMPORTED_MODULE_18__["default"]
                  .range(1, 33)
                  .map(function (x) {
                    return "q".concat(x);
                  });
                this.ts = _utils__WEBPACK_IMPORTED_MODULE_18__["default"]
                  .range(1, 9)
                  .map(function (x) {
                    return "t".concat(x);
                  });
                this.regs = _utils__WEBPACK_IMPORTED_MODULE_18__["default"]
                  .range(0, 100)
                  .map(function (x) {
                    if (x < 10) {
                      return "reg0".concat(x);
                ...
                this.audioLevels =
                  new _audio_audioLevels__WEBPACK_IMPORTED_MODULE_0__[
                    "default"
                  ](this.audio);
                ...
                this.noise = new _noise_noise__WEBPACK_IMPORTED_MODULE_14__[
                  "default"
                ](gl);
                this.image =
                  new _image_imageTextures__WEBPACK_IMPORTED_MODULE_15__[
                    "default"
                  ](gl);
                this.warpShader =
                  new _shaders_warp__WEBPACK_IMPORTED_MODULE_9__["default"](
                    gl,
                    this.noise,
                    this.image,
                    params
                ...
                this.compShader =
                  new _shaders_comp__WEBPACK_IMPORTED_MODULE_10__["default"](
                    gl,
                    this.noise,
                    this.image,
                    params
                ...
                this.outputShader =
                  new _shaders_output__WEBPACK_IMPORTED_MODULE_11__["default"](
                    gl,
                    params
                  );
                this.prevWarpShader =
                ...
                this.blurShader1 =
                  new _shaders_blur_blur__WEBPACK_IMPORTED_MODULE_13__[
                    "default"
                  ](0, this.blurRatios, gl, params);
                this.blurShader2 =
                  new _shaders_blur_blur__WEBPACK_IMPORTED_MODULE_13__[
                    "default"
                  ](1, this.blurRatios, gl, params);
                this.blurShader3 =
                  new _shaders_blur_blur__WEBPACK_IMPORTED_MODULE_13__[
                    "default"
                  ](2, this.blurRatios, gl, params);
                ...
                this.basicWaveform =
                  new _waves_basicWaveform__WEBPACK_IMPORTED_MODULE_3__[
                    "default"
                  ](gl, params);
                this.customWaveforms = _utils__WEBPACK_IMPORTED_MODULE_18__[
                  "default"
                ]
                  .range(4)
                  .map(function (i) {
                    return new _waves_customWaveform__WEBPACK_IMPORTED_MODULE_4__[
                      "default"
                    ](i, gl, params);
                  });
                this.customShapes = _utils__WEBPACK_IMPORTED_MODULE_18__[
                  "default"
                ]
                  .range(4)
                  .map(function (i) {
                    return new _shapes_customShape__WEBPACK_IMPORTED_MODULE_5__[
                      "default"
                    ](i, gl, params);
                  });
                this.prevCustomWaveforms = _utils__WEBPACK_IMPORTED_MODULE_18__[
                  "default"
                ]
                  .range(4)
                  .map(function (i) {
                ...
                this.prevCustomShapes = _utils__WEBPACK_IMPORTED_MODULE_18__[
                  "default"
                ]
                  .range(4)
                  .map(function (i) {
                ...
                this.darkenCenter =
                  new _sprites_darkenCenter__WEBPACK_IMPORTED_MODULE_7__[
                    "default"
                  ](gl, params);
                this.innerBorder =
                  new _sprites_border__WEBPACK_IMPORTED_MODULE_6__["default"](
                    gl,
                    params
                  );
                this.outerBorder =
                ...
                this.motionVectors =
                  new _motionVectors_motionVectors__WEBPACK_IMPORTED_MODULE_8__[
                    "default"
                  ](gl, params);
                this.titleText =
                  new _text_titleText__WEBPACK_IMPORTED_MODULE_16__["default"](
                    gl,
                    params
                  );
                this.blendPattern =
                  new _blendPattern__WEBPACK_IMPORTED_MODULE_17__["default"](
                    params
                  );
                this.resampleShader =
                  new _shaders_resample__WEBPACK_IMPORTED_MODULE_12__[
                    "default"
                  ](gl);
                this.supertext = {
                  startTime: -1,
                ...
                this.blankPreset =
                  _blankPreset__WEBPACK_IMPORTED_MODULE_1___default.a;
                var globalVars = {
                  frame: 0,
                  time: 0,
                  fps: 45,
                ...
                this.presetEquationRunner =
                  new _equations_presetEquationRunner__WEBPACK_IMPORTED_MODULE_2__[
                    "default"
                  ](this.preset, globalVars, params);
                this.prevPresetEquationRunner =
                  new _equations_presetEquationRunner__WEBPACK_IMPORTED_MODULE_2__[
                    "default"
                  ](this.prevPreset, globalVars, params);
                ...
                [
                  ...
                  },
                  {
                    ...
                    value: function setRendererSize(width, height, opts) {
                      ...
                      this.textureRatio =
                        opts.textureRatio || this.textureRatio;
                      this.texsizeX =
                        width * this.pixelRatio * this.textureRatio;
                      this.texsizeY =
                        height * this.pixelRatio * this.textureRatio;
                      this.aspectx =
                        this.texsizeY > this.texsizeX
                          ? this.texsizeX / this.texsizeY
                          : 1;
                      ...
                      if (
                        ...
                        this.resampleShader.renderQuadTexture(
                          this.targetTexture
                        );
                  ...
                  },
                  {
                    ...
                    value: function calcTimeAndFPS(elapsedTime) {
                      ...
                      if (
                        ...
                        var damping = 0.93;
                        this.fps =
                          damping * this.fps + (1.0 - damping) * newFPS;
                      }
                    },
                  },
                  {
                    ...
                    value: function runPixelEquations(
                      ...
                      var warpf0 =
                        11.68 + 4.0 * Math.cos(warpTimeV * 1.413 + 10);
                      var warpf1 = 8.77 + 3.0 * Math.cos(warpTimeV * 1.113 + 7);
                      var warpf2 =
                        10.54 + 3.0 * Math.cos(warpTimeV * 1.233 + 3);
                      var warpf3 =
                        11.49 + 4.0 * Math.cos(warpTimeV * 0.933 + 5);
                        ...
                        for (var ix = 0; ix < gridX1; ix++) {
                          ...
                          if (runVertEQs) {
                            ...
                            if (iz === gridZ / 2 && ix === gridX / 2) {
                              ...
                              ang = _utils__WEBPACK_IMPORTED_MODULE_18__[
                                "default"
                              ].atan2(y * aspecty, x * aspectx);
                            }
                  ...
                  },
                  {
                    ...
                    value: function render() {
                      ...
                      Object.assign(
                        this.regVars,
                        _utils__WEBPACK_IMPORTED_MODULE_18__["default"].pick(
                          this.mdVSVertex,
                          this.regs
                        )
                      );
                      ...
                      if (this.blending) {
                        ...
                        if (
                          ...
                          this.prevCustomWaveforms.forEach(
                            function (waveform, i) {
                              waveform.drawCustomWaveform(
                                1.0 - _this.blendProgress,
                                _this.audio.timeArrayL,
                  ...
                  },
                  {
                    ...
                    value: function mixFrameEquations(
                      ...
                      mixedFrame.echo_zoom =
                        mix * mdVSFrame.echo_zoom +
                        mix2 * mdVSFramePrev.echo_zoom;
  ...
  \********************************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var _blurVertical__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(
              /*! ./blurVertical */ "./src/rendering/shaders/blur/blurVertical.js"
            );
          /* harmony import */ var _blurHorizontal__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(
              /*! ./blurHorizontal */ "./src/rendering/shaders/blur/blurHorizontal.js"
            );
          function _classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) {
              throw new TypeError("Cannot call a class as a function");
          ...
          var BlurShader =
            ...
            (function () {
              function BlurShader(blurLevel, blurRatios, gl) {
                ...
                this.blurHorizontal =
                  new _blurHorizontal__WEBPACK_IMPORTED_MODULE_1__["default"](
                    gl,
                    this.blurLevel,
                    opts
                  );
                this.blurVertical =
                  new _blurVertical__WEBPACK_IMPORTED_MODULE_0__["default"](
                    gl,
                    this.blurLevel,
                    opts
                  );
              ...
              _createClass(BlurShader, [
                ...
                },
                {
                  ...
                  value: function setupFrameBufferTextures() {
                    ...
                    var dstTexsizeVertical = this.getTextureSize(
                      dstBlurRatios[1]
                    );
                    this.bindFrameBufferTexture(
  ...
  \******************************************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var _shaderUtils__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(
              /*! ../shaderUtils */ "./src/rendering/shaders/shaderUtils.js"
            );
          function _classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) {
              throw new TypeError("Cannot call a class as a function");
          ...
          var BlurHorizontal =
            ...
            (function () {
              function BlurHorizontal(gl, blurLevel) {
                ...
                this.floatPrecision = _shaderUtils__WEBPACK_IMPORTED_MODULE_0__[
                  "default"
                ].getFragmentFloatPrecision(this.gl);
                this.createShader();
              }
              ...
              _createClass(BlurHorizontal, [
                ...
                },
                {
                  ...
                  value: function renderQuadTexture(
                    ...
                    var _this$getScaleAndBias = this.getScaleAndBias(
                        blurMins,
                        blurMaxs
                      ),
                  ...
                  },
                  {
                    ...
                    value: function createShader() {
                      ...
                      if (shaderText.length === 0) {
                        ...
                        var shaderParts =
                          _shaderUtils__WEBPACK_IMPORTED_MODULE_0__[
                            "default"
                          ].getShaderParts(shaderText);
                      ...
                      this.userTextures =
                        _shaderUtils__WEBPACK_IMPORTED_MODULE_0__[
                          "default"
                        ].getUserSamplers(fragShaderHeaderText);
                      this.shaderProgram = this.gl.createProgram();
                      var vertShader = this.gl.createShader(
                        this.gl.VERTEX_SHADER
                      );
                      ...
                      for (var i = 0; i < this.userTextures.length; i++) {
                        ...
                        userTexture.textureLoc = this.gl.getUniformLocation(
                          this.shaderProgram,
                          "sampler_".concat(userTexture.sampler)
                        );
                      }
                    },
                  },
                  ...
                  value: function getUserSamplers(text) {
                    ...
                    if (lineMatches && lineMatches.length > 0) {
                      for (var i = 0; i < lineMatches.length; i++) {
                        var samplerMatches =
                          lineMatches[i].match(samplerMatcher);
  ...
  \*********************************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(/*! ../../utils */ "./src/utils.js");
          /* harmony import */ var _shaders_shaderUtils__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(
              /*! ../shaders/shaderUtils */ "./src/rendering/shaders/shaderUtils.js"
            );
          function _classCallCheck(instance, Constructor) {
          ...
          var CustomShape =
            ...
            (function () {
              function CustomShape(index, gl, opts) {
                ...
                this.floatPrecision =
                  _shaders_shaderUtils__WEBPACK_IMPORTED_MODULE_1__[
                    "default"
                  ].getFragmentFloatPrecision(this.gl);
                this.createShader();
              ...
              _createClass(TitleText, [
                {
                  ...
                  value: function generateTitleTexture(text) {
                    ...
                    var titleText = text;
                    var textLength =
                      this.context2D.measureText(titleText).width;
                ...
                },
                {
                  ...
                  value: function renderTitle(progress, flip, globalVars) {
                    this.gl.useProgram(this.shaderProgram);
                    var progressUvs = this.generateUvs(
                      progress,
                      flip,
                      globalVars
                    );
  ...
  \**********************************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var _waveUtils__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(
              /*! ./waveUtils */ "./src/rendering/waves/waveUtils.js"
            );
          function _classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) {
              throw new TypeError("Cannot call a class as a function");
                  ...
                  },
                  {
                    ...
                    value: function generateWaveform(
                      ...
                      if (
                        ...
                        for (var it = 0; it < its; it++) {
                          ...
                          if (waveMode === 0) {
                            ...
                            for (var i = 0; i < numVert - 1; i++) {
                              var rad =
                                0.5 +
                                0.4 * waveR[i + sampleOffset] +
                                fWaveParam2;
                              var ang =
                                i * numVertInv * 2 * Math.PI +
                                mdVSFrame.time * 0.2;
                            ...
                            if (mdVSFrame.modwavealphabyvolume > 0) {
                              ...
                              alpha *=
                                (vol - mdVSFrame.modwavealphastart) /
                                _alphaDiff;
                            }
                            ...
                            for (var _i4 = 0; _i4 < numVert; _i4++) {
                              var x =
                                ...
                                (wavePosX - 1) +
                                waveR[
                                  (_i4 + 25 + _sampleOffset) % waveL.length
                                ] *
                                  0.44;
                              var y =
                                waveL[_i4 + _sampleOffset] * 0.47 + wavePosY; // momentum
                            ...
                            for (var _i5 = 0; _i5 < waveL.length; _i5++) {
                              ...
                              var x0 =
                                waveR[_i5] * waveL[ioff] +
                                waveL[_i5] * waveR[ioff];
                              var y0 =
                                waveR[_i5] * waveR[_i5] -
                                waveL[ioff] * waveL[ioff];
                              positions[_i5 * 3 + 0] =
                                (x0 * cosRot - y0 * sinRot) *
                            ...
                            var edgex = [
                              wavePosX * Math.cos(_ang2 + Math.PI * 0.5) -
                                dx * 3.0,
                              wavePosX * Math.cos(_ang2 + Math.PI * 0.5) +
                                dx * 3.0,
                            ];
                            var edgey = [
                              wavePosX * Math.sin(_ang2 + Math.PI * 0.5) -
                                dy * 3.0,
                              wavePosX * Math.sin(_ang2 + Math.PI * 0.5) +
                                dy * 3.0,
                            ];
                          ...
                          if (newWaveMode === 7) {
                            ...
                            for (var _i10 = 0; _i10 < this.numVert; _i10++) {
                              ...
                              this.positions[_i10 * 3 + 0] =
                                this.positions[_i10 * 3 + 0] * mix + _x * mix2;
                            ...
                            for (var _i11 = 0; _i11 < this.numVert; _i11++) {
                              ...
                              this.positions2[_i11 * 3 + 0] =
                                this.positions2[_i11 * 3 + 0] * mix +
                                _x2 * mix2;
                              this.positions2[_i11 * 3 + 1] =
                                this.positions2[_i11 * 3 + 1] * mix +
                                _y2 * mix2;
                            ...
                            for (var _i12 = 0; _i12 < halfNumVert; _i12++) {
                              ...
                              this.positions[_i12 * 3 + 0] =
                                this.positions[_i12 * 3 + 0] * mix + _x3 * mix2;
                            ...
                            for (var _i13 = 0; _i13 < halfNumVert; _i13++) {
                              ...
                              this.positions2[_i13 * 3 + 0] =
                                this.positions[(_i13 + halfNumVert) * 3 + 0] *
                                  mix +
                                _x4 * mix2;
                              this.positions2[_i13 * 3 + 1] =
                                this.positions[(_i13 + halfNumVert) * 3 + 1] *
                                  mix +
                                _y4 * mix2;
                            ...
                            for (var _i14 = 0; _i14 < this.numVert; _i14++) {
                              ...
                              this.positions[_i14 * 3 + 0] =
                                this.positions[_i14 * 3 + 0] * mix + _x5 * mix2;
                        ...
                        _waveUtils__WEBPACK_IMPORTED_MODULE_1__[
                          "default"
                        ].smoothWave(
                          this.positions,
                    ...
                    value: function drawBasicWaveform(
                      ...
                      if (
                        ...
                        var drawMode =
                          mdVSFrame.wave_dots !== 0
                            ? this.gl.POINTS
                            : this.gl.LINE_STRIP; // TODO: use drawArraysInstanced
  ...
  \***********************************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var _waveUtils__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(
              /*! ./waveUtils */ "./src/rendering/waves/waveUtils.js"
            );
          function _classCallCheck(instance, Constructor) {
          ...
          var CustomWaveform =
            ...
            (function () {
              function CustomWaveform(index, gl, opts) {
                ...
                this.smoothedColors = new Float32Array(
                  (maxSamples * 2 - 1) * 4
                );
                this.texsizeX = opts.texsizeX;
                this.texsizeY = opts.texsizeY;
              ...
              _createClass(CustomWaveform, [
                ...
                },
                {
                  ...
                  value: function generateWaveform(
                    ...
                    if (
                      waveEqs.baseVals.enabled !== 0 &&
                      timeArrayL.length > 0
                    ) {
                      var mdVSWave = Object.assign(
                        {},
                      ...
                      if (
                        ...
                        var j0 = useSpectrum
                          ? 0
                          : Math.floor(
                              (maxSamples - this.samples) / 2 - sep / 2
                            );
                        var j1 = useSpectrum
                          ? 0
                          : Math.floor(
                        ...
                        if (usedots === 0) {
                          _waveUtils__WEBPACK_IMPORTED_MODULE_2__[
                            "default"
                          ].smoothWaveAndColor(
                            this.positions,
                            this.colors,
  ...
  \***************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var _audio_audioProcessor__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(
              /*! ./audio/audioProcessor */ "./src/audio/audioProcessor.js"
            );
          /* harmony import */ var _rendering_renderer__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(
              /*! ./rendering/renderer */ "./src/rendering/renderer.js"
            );
          function _classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) {
              throw new TypeError("Cannot call a class as a function");
          ...
          var Visualizer =
            ...
            (function () {
              function Visualizer(audioContext, canvas, opts) {
                ...
                this.audio =
                  new _audio_audioProcessor__WEBPACK_IMPORTED_MODULE_0__[
                    "default"
                  ](audioContext);
                ...
                this.renderer =
                  new _rendering_renderer__WEBPACK_IMPORTED_MODULE_1__[
                    "default"
                  ](gl, this.audio, opts);
              }
                ...
                },
                {
                  ...
                  value: function loadPreset(presetMap) {
                    ...
                    for (var _i = 0; _i < preset.waves.length; _i++) {
                      preset.waves[_i].baseVals = Object.assign(
                        {},
                        this.waveBaseValsDefaults,
                    ...
                    if (typeof preset.init_eqs !== "function") {
                      ...
                      preset.init_eqs = new Function(
                        "a",
                        "".concat(preset.init_eqs_str, " return a;")
                      );
                      preset.frame_eqs = new Function(
                        "a",
                        "".concat(preset.frame_eqs_str, " return a;")
                      );

                      if (preset.pixel_eqs_str && preset.pixel_eqs_str !== "") {
                        preset.pixel_eqs = new Function(
                          "a",
                          "".concat(preset.pixel_eqs_str, " return a;")
                        );
                      } else {
                        preset.pixel_eqs = "";
                      }
                      ...
                      for (var _i2 = 0; _i2 < preset.shapes.length; _i2++) {
                        if (preset.shapes[_i2].baseVals.enabled !== 0) {
                          preset.shapes[_i2] = Object.assign(
                            {},
                            preset.shapes[_i2],
                            {
                              init_eqs: new Function(
                                "a",
                                "".concat(
                                  preset.shapes[_i2].init_eqs_str,
                                  " return a;"
                                )
                              ),
                              frame_eqs: new Function(
                                "a",
                                "".concat(
                                  preset.shapes[_i2].frame_eqs_str,
                                  " return a;"
                                )
                              ),
                            }
                        ...
                        if (preset.waves[_i3].baseVals.enabled !== 0) {
                          var wave = {
                            ...
                            frame_eqs: new Function(
                              "a",
                              "".concat(
                                preset.waves[_i3].frame_eqs_str,
                                " return a;"
                              )
                            ),
                          };
                          ...
                          preset.waves[_i3] = Object.assign(
                            {},
                            preset.waves[_i3],
                            wave
                          );
